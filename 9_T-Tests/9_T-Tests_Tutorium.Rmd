...
\setstretch{1}
\large
\color{darkblue}13. Geben Sie die Definition des p-Wertes  für einen zweiseitigen Einstichproben-T-Test wieder.
...
welchem man die Nullhypothese basierend auf einem vorliegenden Wert der
...
\color{darkgrey}
\begin{align*}
T \sim t(\delta, 2+3-2) \mbox{ mit } \delta = \sqrt{\frac{n_1n_2}{n_1+n_2}}\left(\frac{\mu_1-\mu_2 - \mu_0}{\sigma}\right)
\end{align*}
\footnotesize
...
T := \sqrt{\frac{n_1n_2}{n_1+n_2}}\left(\frac{\bar{\upsilon}_1-\bar{\upsilon}_2-\mu_0}{s_{12}}\right)
\end{equation}
Dann ist der zweiseitige \textit{Zweistichproben-T-Test} definiert als
der kritische wertbasierte Test
\begin{equation}
\phi(\upsilon) := 1_{\{|T| \ge k\}}.
\end{equation}
\end{definition}
...
einem vorliegenden Wert der Teststatistik ablehnen würde.
